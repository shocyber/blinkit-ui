            ...
            <div className="flex-1 bg-white">
              <div className="space-y-3 my-3">
                ...
                <div className="bg-white">
                  <div className="px-4 text-sm space-y-3 py-2">
                    <div className="relative ">
                      ...
                      <label
                        htmlFor="address"
                        className="absolute font-semibold font-caros text-md text-slate-600  duration-300 transform -translate-y-4 scale-75 top-1 z-10 origin-[0] bg-[#f7f8fafe]  px-2 peer-focus:px-2 peer-focus:text-black peer-focus:dark:text-black peer-placeholder-shown:scale-100 peer-placeholder-shown:-translate-y-1/2 peer-placeholder-shown:top-1/2 peer-focus:top-2 peer-focus:scale-75 peer-focus:-translate-y-4 left-1"
                      >
                        Complete Address
                      </label>
                    </div>
